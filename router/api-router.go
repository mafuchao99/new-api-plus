...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/pricing/routes", middleware.HeaderNavModuleAuth("pricing"), controller.GetRoutePricing)
		...
		routeLineRoute := apiRouter.Group("/route-lines")
		routeLineRoute.Use(middleware.AdminAuth())
		{
			routeLineRoute.GET("/", controller.GetRouteLines)
			routeLineRoute.GET("/slots", controller.GetRouteSlots)
			routeLineRoute.POST("/slots", controller.CreateRouteSlot)
			routeLineRoute.PUT("/slots/:slot_id", controller.UpdateRouteSlot)
			routeLineRoute.POST("/", controller.CreateRouteLine)
			routeLineRoute.PUT("/:id", controller.UpdateRouteLine)
			routeLineRoute.POST("/:id/model-prices", controller.SaveRouteLineModelPrice)
			routeLineRoute.DELETE("/:id/model-prices/:price_id", controller.DeleteRouteLineModelPrice)
			routeLineRoute.POST("/:id/bindings", controller.SaveChannelRouteBinding)
			routeLineRoute.DELETE("/:id/bindings/:binding_id", controller.DeleteChannelRouteBinding)
		}
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/route-options", controller.GetTokenRouteOptions)
			tokenRoute.GET("/admin/users/:user_id", middleware.AdminAuth(), middleware.DisableCache(), controller.GetAdminUserTokens)
			tokenRoute.POST("/admin/route-switch", middleware.AdminAuth(), controller.SwitchAdminTokenRoutes)
			tokenRoute.POST("/admin/route-lock", middleware.AdminAuth(), controller.LockAdminTokenRoute)
			...
			tokenRoute.POST("/batch/create", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.BatchCreateTokens)
			tokenRoute.POST("/batch/disable", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.BatchDisableTokens)
		...
		upstreamRoute.Use(middleware.AdminAuth())
		{
			...
			upstreamRoute.POST("/test_email", controller.SendUpstreamAlertTestEmail)
			upstreamRoute.GET("/monitor_settings", controller.GetUpstreamMonitorSettings)
			upstreamRoute.PUT("/monitor_settings", controller.UpdateUpstreamMonitorSettings)
