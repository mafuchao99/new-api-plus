...
// ----------------------------------------------------------------------------
//
// Used by the sample-data layer (lib/mock-store.ts) so the same upstream
// account always renders the same balance/status instead of jittering on every
// render. Delete together with mock-store.ts once the backend ships the real
// /api/upstream/* endpoints.
