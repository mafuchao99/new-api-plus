...
export const STATIC_I18N_KEYS = [
  ...
  'Low Balance',
  'Normal',
  'Failed to load upstream accounts',
  'Failed to search upstream accounts',
  'Failed to create upstream account',
  'Failed to update upstream account',
  'Failed to delete upstream account',
  'Failed to update account status',
  'Failed to save alert settings',
  'Upstream account created successfully',
  'Upstream account updated successfully',
  'Upstream account deleted successfully',
  'Upstream account enabled successfully',
  'Upstream account disabled successfully',
  ...
  'Remark must be at most {{max}} characters',
